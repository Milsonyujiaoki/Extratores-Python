...
set PDF_BASE_PATH=C:\Users\Maoki\CorpServices\Pericia Abordin - Marimex - Doc's completos
set RESULTS_BASE_PATH=../../resultados
...
cd /d "%~dp0"
"C:\Users\Maoki\.virtualenvs\Projetos-5b04BKsC\Scripts\python.exe" extracao_openai_vision_novo.py
